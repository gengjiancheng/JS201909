...
console.log([1, 2, 3, 4, 5].rm(4)) // 随机删除了两项 返回值是删除的项组成的新数组

Array.prototype.unique = function () {
    // 双for去重  每一轮都用当前项跟后边每一项比较，相等 就把后边的项删除，注意数组塌陷
    // 对象去重  利用对象的属性名不能重复的特点
    // indexof 和  lastindexof 合起来使用的去重：看当前的indexof和lastindexof是否相等，相等说明不重复
...
console.log(str.getParame('b')); //'13'
