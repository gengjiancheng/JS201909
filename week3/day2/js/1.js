var reg = /^[0-9a-z]$/ //以一个数字或者小写字母开头 还必须以这个字符结尾；意思也就是中间只能一个数字或字母
...
var reg7 = /^\d{3}$/ //以数字开头 以数字结尾中间 三个数字
...
console.log(reg7.test('你6你6你6')) //false
console.log(reg7.test('666')) //true
console.log(reg7.test('1234641fjlkang')) //false
...
var reg8 = /^\d{3,6}$///以数字开头 以数字结尾 中间3到6个数字
